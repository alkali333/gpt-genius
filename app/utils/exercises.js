const meditations = {
  ...
  gratitude: [
    "Guide the client to reflect on a skill they have developed, and then lead them to express gratitude for the opportunities and experiences that allowed them to develop that skill.",
    "Ask the client to reflect on an achievement they are proud of, and then guide them to express gratitude for the skills and abilities that enabled them to reach that achievement.",
    "Guide the client to visualize a situation where they successfully used a skill or achieved something significant. Then, encourage them to express gratitude for this success and for the abilities that enabled it.",
    "Ask the client to visualize a celebration in their honor, recognizing both their skills and achievements, and the things they are grateful for. Encourage them to feel a sense of pride and gratitude.",
    "Encourage the client to reflect on how their skills and achievements have contributed to their personal growth. Then guide them to express gratitude for this growth and for the abilities that enabled it.",
    "Guide the client to visualize themselves using their skills and achievements to overcome a challenge. Then, encourage them to express gratitude for their strength and resilience.",
    "Ask the client to list their skills and achievements, and then guide them to express gratitude for each one, while also acknowledging the self-confidence that comes from recognizing their own abilities.",
    "Guide the client to create positive affirmations that combine acknowledgment of their skills and achievements with expressions of gratitude. For example, 'I am grateful for my ability to [skill] which has led me to [achievement]'",
    "Ask the client to visualize the positive impact their skills and achievements have had on others, and then guide them to express gratitude for the opportunity to make a difference.",
    "Encourage the client to reflect on the opportunities they have had to use their skills and achieve their goals, and then guide them to express gratitude for these opportunities.",
  ],
  empowerment: [
    " Guide the client to visualize themselves successfully completing each task from their 'current tasks' list. Then, encourage them to imagine how completing each task brings them one step closer to their long-term hopes and dreams.",
    " Ask the client to create positive affirmations that link their current tasks to their long-term hopes and dreams. For example, 'Completing [current task] is bringing me closer to [long-term dream]'.",
    " Guide the client to visualize the sense of accomplishment they will feel upon completing all the tasks on their 'current tasks' list, and how this will contribute to achieving their long-term hopes and dreams.",
    " Ask the client to reflect on how each task on their 'current tasks' list is connected to their long-term hopes and dreams. Encourage them to see the bigger picture and the purpose behind each task.",
    " Guide the client to visualize themselves empowered and confident, successfully completing their 'current tasks' and moving towards their long-term hopes and dreams.",
    "Ask the client to reflect on their past achievements and the strengths they used to achieve them. Encourage them to see how these strengths can empower them to complete their 'current tasks' and achieve their hopes and dreams.",
    " Ask the client to visualize any potential obstacles that may arise while completing their 'current tasks', and then guide them to visualize themselves overcoming these obstacles with confidence and determination.",
    " Encourage the client to reflect on the reasons behind their long-term hopes and dreams, and how these reasons can motivate them to complete their 'current tasks'.",
    " Guide the client to visualize their future, having completed all their 'current tasks' and achieved their long-term hopes and dreams. Encourage them to feel the sense of accomplishment and fulfillment.",
  ],
  current_tasks: [
    " Instruction: Guide the client to imagine themselves in the future, having already completed all their current tasks. For each one, encourage them to visualize the details of their success, how it feels, and what they are doing.",
    " Instruction: Ask the client to visualize the obstacles and challenges they are currently facing in completing their current tasks. Encourage them to imagine themselves successfully overcoming each one, and feeling a sense of accomplishment and relief.",
    "Instruction: Guide the client to visualize a ball of positive energy in their hands. Encourage them to imagine this energy ball filling with all the positive emotions, thoughts, and experiences they need to complete their current tasks . Then guide them to imagine absorbing this energy into their body, filling them with positivity and strength.",
    " Instruction: Ask the client to visualize a cord of energy extending from their root chakra (base of their spine) down into the earth. Guide them to imagine this cord grounding them and providing them with stability and strength to overcome their challenges and obstacles  in completing their current tasks.",
    "Instruction: Guide the client to recall a time when they felt really resourceful, confident, and successful. Encourage them to immerse themselves in that memory, and then visualize transferring that state to their current tasks .",
    "Instruction: Guide the client to focus on things that they are grateful for based on the provided user info. Encourage them to feel the gratitude deeply, and then visualize this positive energy helping them in manifesting their goals and overcoming challenges in completing their current tasks.",
    " Instruction: Ask the client to visualize a healing light enveloping their body, healing any physical, emotional, or mental blocks that are preventing them from completing their current tasks .",
    " Instruction: Guide the client to visualize themselves working on their current tasks  creatively and efficiently. Encourage them to imagine the process of completing their tasks as a creative and enjoyable journey.",
    "Instruction: Ask the client to recall a time when they felt extremely confident and successful – ask them to squeeze their thumb and forefinger together to anchor the feeling. Once in this state of mind, go through their current tasks as recorded in the user info. Explain how they can squeeze their thumb and forefinger together whenever they want to feel powerful and confident.",
    " Instruction: Guide the client to imagine a golden bridge in front of them that represents their path to completing their current tasks . Encourage them to visualize themselves walking across this bridge with confidence and ease, overcoming any obstacles and challenges that arise along the way.",
  ],
  misc: [
    ...
    "Have the client breath in golden light representing each one of their hopes and dreams, and breathe out dark smoke representing each obstacle and challenge. Use the recorded user info.",
  ],
};
...
export const getRandomExercise = (type = null) => {
  if (type && type in meditations) {
    ...
    return `Using the user info, create a 350 word exercise: ${exerciseContent}`;
  }
};
